...
const About = () => (
  <div className="bg-gray-100">
    ...
    <section className="py-12 px-6 max-w-6xl mx-auto text-center">
      ...
      <img
        src="/journey_Img2.jpeg"
        alt="Who I Am"
        className="rounded-lg shadow-lg mx-auto mb-6 h-96 w-auto object-cover"
      />
      <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto mb-8 text-justify">
        I am a certified professional coach, dietician, and proud titleholder of
        <span className="font-semibold"> Mr. India </span> and
        <span className="font-semibold"> Mr. Delhi</span>.
        With years of experience and having successfully guided
        <span className="font-semibold"> 1500+ clients</span>, my mission is to help people
        transform their bodies and lifestyles through effective training and personalized
        nutrition plans. I believe in building healthy habits that last a lifetime and
        empowering my clients to become the best version of themselves.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-semibold mb-2">1500+ Clients Transformed</h3>
          <p className="text-gray-600">
    ...
    <section className="py-12 px-6 max-w-6xl mx-auto text-center">
      ...
      <img
        src="/journey_Img1.jpeg"
        alt="Journey"
        className="rounded-lg shadow-lg mx-auto h-96 w-auto object-cover"
      />
    </section>
